import { N as NOOP_MIDDLEWARE_HEADER, R as REDIRECT_STATUS_CODES, A as AstroError, a as ActionsReturnedInvalidDataError, D as DEFAULT_404_COMPONENT } from './astro/server_BcspQKrc.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { OS: process.env.OS, _: process.env._ })?.DEV) {
